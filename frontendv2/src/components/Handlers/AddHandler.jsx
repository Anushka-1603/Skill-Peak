...
// import { createHandler } from '../../services/handler.service';

// const AddHandler = ({ onSuccess, onCancel }) => {
...
//       setError(err.response?.data?.message || 'Failed to create handler. Please try again.');
//     } finally {
//       setLoading(false);
//     }
//   };
...
//     <Card>
//       <div className="p-4">
//         <h3 className="text-lg font-medium mb-4">Add New Handler</h3>
...
// src/components/Handlers/AddHandler.jsx
import React, { useState } from 'react';
